...
export const products: Product[] = [
  ...
  {
    id: "heritage-004",
    name: "The Sapphire Matriarch",
    collection: "heritage",
    collectionName: "Heritage Line",
    price: 550,
    image: "/images/products/female/female-blue,white.png",
    description: "A garment woven from the clarity of the northern skies. This tunic drapes with the serenity of the Volta, crowning the woman who leads with quiet, absolute power.",
    symbolism: "Blue whispers of harmony and peace; white stands for unblemished truth.",
    construction: "Delicate hand-loomed cotton with royal finishing",
  },
  {
    id: "heritage-005",
    name: "The Amber Empress",
    collection: "heritage",
    collectionName: "Heritage Line",
    price: 550,
    image: "/images/products/female/brown-yellow.png",
    description: "Forged in the golden hours of the Savannah. This piece carries the warmth of the sun-drenched earth, radiating a wealth that is as timeless as the soil itself.",
    symbolism: "Gold for boundless prosperity, brown for the enduring strength of the earth.",
    construction: "Premium structured weave with harvest textures",
  },
];
